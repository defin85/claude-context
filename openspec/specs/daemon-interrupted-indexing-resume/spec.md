# daemon-interrupted-indexing-resume Specification

## Purpose
TBD - created by archiving change resume-interrupted-indexing-on-daemon-start. Update Purpose after archive.
## Requirements
