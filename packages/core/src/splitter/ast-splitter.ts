...
export class AstCodeSplitter implements Splitter {
    ...
    constructor(chunkSize?: number, chunkOverlap?: number) {
        ...
        this.langchainFallback = new LangChainCodeSplitter(
            chunkSize,
            chunkOverlap,
        );
    }
    ...
    async split(
        ...
        try {
            ...
            if (!tree.rootNode) {
                ...
                return await this.langchainFallback.split(
                    code,
                    language,
                    filePath,
                );
    ...
    private getLanguageConfig(
        ...
        const langMap: Record<string, { parser: any; nodeTypes: string[] }> = {
            ...
            bsl: { parser: Bsl, nodeTypes: SPLITTABLE_NODE_TYPES.bsl },
            "1c": { parser: Bsl, nodeTypes: SPLITTABLE_NODE_TYPES.bsl },
        };
