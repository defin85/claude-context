...
function createConfig(overrides: Partial<ContextMcpConfig> = {}): ContextMcpConfig {
    return {
        ...
        acceleratorAdaptiveBackpressure: true,
        acceleratorAdaptiveMinEmbeddingConcurrency: 1,
        acceleratorAdaptiveHighPressureThreshold: 1,
        acceleratorAdaptiveLowPressureThreshold: 0.5,
        acceleratorAdaptiveHealthySampleCount: 3,
        acceleratorAdaptiveCooldownMs: 5000,
        acceleratorAdaptiveInsertBacklogThreshold: 2,
        acceleratorAdaptiveInsertBacklogMinBatches: 30,
        acceleratorAdaptiveInsertLatencyMsThreshold: 30000,
        acceleratorAdaptiveRetryRateThreshold: 0.5,
        acceleratorAdaptiveRetryRateMinBatches: 10,
        acceleratorAdaptiveRejectedWorkersThreshold: 1,
        acceleratorAdaptiveMemoryFreePercentThreshold: 3,
        acceleratorAdaptiveVramUsageLimitPercent: 90,
